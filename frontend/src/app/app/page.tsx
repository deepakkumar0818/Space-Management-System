...
const mockLocations: WorkspaceLocation[] = [
  {
    id: "sector-17-chandigarh",
    name: "Sector 17 Business Center",
    area: "Sector 17",
    city: "Chandigarh",
    hotDeskFrom: "₹ 199 / day",
    meetingRoomFrom: "₹ 499 / hour",
    availabilitySummary: "Good availability today · best for hot desks",
    hotDeskPrice: 199,
    meetingRoomPrice: 499,
    type: "both",
    capacity: 12,
    status: "available",
  },
  {
    id: "sector-34-chandigarh",
    name: "Sector 34 Corporate Hub",
    area: "Sector 34",
    city: "Chandigarh",
    hotDeskFrom: "₹ 299 / day",
    meetingRoomFrom: "₹ 699 / hour",
    availabilitySummary: "Meeting rooms filling fast · peak pricing",
    hotDeskPrice: 299,
    meetingRoomPrice: 699,
    type: "both",
    capacity: 20,
    status: "filling_fast",
  },
  {
    id: "sector-8-chandigarh",
    name: "Sector 8 Workspace",
    area: "Sector 8",
    city: "Chandigarh",
    hotDeskFrom: "₹ 249 / day",
    meetingRoomFrom: "₹ 599 / hour",
    availabilitySummary: "Quiet focus zones · ideal for remote work",
    hotDeskPrice: 249,
    meetingRoomPrice: 599,
    type: "desk",
    capacity: 8,
    status: "available",
  },
  {
    id: "phase-8-mohali",
    name: "Phase 8 Business Park",
    area: "Phase 8",
    city: "Mohali",
    hotDeskFrom: "₹ 349 / day",
    meetingRoomFrom: "₹ 799 / hour",
    availabilitySummary: "Close to IT hub · strong demand during weekdays",
    hotDeskPrice: 349,
    meetingRoomPrice: 799,
    type: "both",
    capacity: 16,
    status: "peak",
  },
  {
    id: "phase-5-mohali",
    name: "Phase 5 Tech Center",
    area: "Phase 5",
    city: "Mohali",
    hotDeskFrom: "₹ 219 / day",
    meetingRoomFrom: "₹ 549 / hour",
    availabilitySummary: "Plenty of hot desks · limited large meeting rooms",
    hotDeskPrice: 219,
    meetingRoomPrice: 549,
    type: "desk",
    capacity: 6,
    status: "limited",
  },
  {
    id: "sector-82-mohali",
    name: "Sector 82 Innovation Hub",
    area: "Sector 82",
    city: "Mohali",
    hotDeskFrom: "₹ 259 / day",
    meetingRoomFrom: "₹ 599 / hour",
    availabilitySummary: "Modern facilities · popular with startups",
    hotDeskPrice: 259,
    meetingRoomPrice: 599,
    type: "meeting_room",
    capacity: 10,
  ...
  {
    id: "sector-22-chandigarh",
    name: "Sector 22 Executive Suites",
    area: "Sector 22",
    city: "Chandigarh",
    hotDeskFrom: "₹ 279 / day",
    meetingRoomFrom: "₹ 649 / hour",
    availabilitySummary: "Premium location · executive workspace",
    hotDeskPrice: 279,
    meetingRoomPrice: 649,
    type: "both",
    capacity: 14,
    status: "available",
  },
  {
    id: "phase-10-mohali",
    name: "Phase 10 Corporate Plaza",
    area: "Phase 10",
    city: "Mohali",
    hotDeskFrom: "₹ 229 / day",
    meetingRoomFrom: "₹ 579 / hour",
    availabilitySummary: "Spacious work areas · great for teams",
    hotDeskPrice: 229,
    meetingRoomPrice: 579,
    type: "both",
    capacity: 18,
    status: "available",
  },
